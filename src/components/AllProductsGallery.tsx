  ...
  return (
    <section>
      <div className="mt-20 px-4 mb-2 md:mt-32 xl:mt-40 flex justify-between w-full">
        <img className="w-1/5" src="/All-Stock-Header.svg " alt="Sale" />
      </div>
      <div>
        <SortProducts />
      </div>
      <div className="grid grid-cols-4 gap-y-3 xs:gap-y-8 sm:gap-y-14 md:gap-y-20 lg:gap-y-24 xl:gap-28 2xl:gap-y-32gap-x-6 px-6">
