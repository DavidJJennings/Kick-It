const Footer = () => {
  return (
    <section className="flex bg-black text-white p-4 justify-around items-start text-left mt-8 text-[0.5rem] sm:text-xs md:text-sm md:p-8 lg:text-base xl:text-lg 2xl:text-xl">
